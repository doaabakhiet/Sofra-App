        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            {!! Form::open(['route' => 'dashboard.clients.store', 'method' => 'post']) !!}
                            @csrf
                            <div class="form-group">
                                ...
                                {{--  --}}
                                {{ Form::label('neighborhood', null, ['class' => 'control-label']) }}
                                <br>
                                @error('neighbourhood_id')
                                    <label class="text-danger">{{ $message }}</label>
                                @enderror
                                {!! Form::select('neighborhood_id', $neighborhoods->pluck('name', 'id')->toArray(), null, [
                                    'class' => 'custom-select',
                                    'placeholder' => 'Pick Neighborhood',
                                ]) !!}
                            </div>
                            {{-- <div class="form-group">
