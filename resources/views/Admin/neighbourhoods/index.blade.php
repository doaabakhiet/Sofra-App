      ...
      <div class="row mb-2">
          ...
          <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item">Nnighbourhoods</li>
              </ol>
          </div>
      </div>
  </div><!-- /.container-fluid -->
                        ...
                        <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <a href="{{ Route('dashboard.neighbourhoods.create') }}"
                                        ...
                                        <tbody>
                                            @forelse($neighbourhoods as $item)
                                                <tr class="odd">
                                                    ...
                                                    <td>{{ $item->name }}</td>
                                                    <td class="text-secondary">{{ $item->cities->name }}</td>
                                                    <td><a href="{{ Route('dashboard.neighbourhoods.edit', $item->id) }}"
                                                            class="btn btn-outline-primary"><i class="fa fa-pen"></i></a></td>
                                                    <td>
                                                        {!! Form::open([
                                                            'route' => ['dashboard.neighbourhoods.destroy', $item->id],
                                                            'method' => 'delete',
                                                            'class' => 'delete-form',
                                                        ]) !!}
